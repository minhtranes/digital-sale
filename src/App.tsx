...
export default function App() {
  ...
  function sidebarHandler(event: React.MouseEvent<HTMLElement>) {
    var sideBar = (event.target as any).index;
    if (moved) {
    ...
    <Router>
      <div className="flex flex-col h-screen">
            ...
            <ul className="mt-5 w-42">
              <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <Link to="/overview" className="text-sm ml-2">
                    Dashboard
                  </Link>
                </div>
              ...
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <Link to="/services" className="text-sm  ml-2">
                    Products
                  </Link>
                </div>
                <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
              ...
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center">
                <div className="flex items-center">
                  ...
                  <Link to="/settings" className="text-sm  ml-2">
                    Settings
                  </Link>
                </div>
              </li>
        ...
        <div className="flex flex-col h-full w-full pl-52">
          {/* Navbar starts */}
          <Disclosure as="nav" className="relative bg-gray-800 shadow-xl mb-1">
            {({ open }) => (
              <>
                      ...
                      <div className="h-16 w-56 flex items-center">
                        ...
                        >
                          ...
                          <path fill="url(#sw-gradient)"
                            d="M16.5,-14.6C23.1,-10,31.2,-5,31.7,0.4C32.1,5.8,24.8,11.6,18.2,15C11.6,18.4,5.8,19.4,-1.7,21.2C-9.2,22.9,-18.5,25.3,-24.4,21.9C-30.3,18.5,-32.9,9.2,-33.2,-0.3C-33.6,-9.9,-31.7,-19.9,-25.8,-24.5C-19.9,-29.1,-9.9,-28.4,-2.5,-25.9C5,-23.4,10,-19.2,16.5,-14.6Z"
